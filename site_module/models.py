...
class FooterLink(models.Model):
    ...
    footer_link_box = models.ForeignKey(to=FooterLinkBox, on_delete=models.CASCADE, verbose_name='دسته بندی', related_name='footer_link')
...
class SiteBanner(models.Model):
    ...
    class SiteBannerPositions(models.TextChoices):
        ...
        product_detail = 'product_detail', 'صفحه ی جزئیات محصولات'
